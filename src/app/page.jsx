      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            Programmer | Robotics Enthusiast | Innovator
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I'm Malek, a passionate programmer and robotics enthusiast with a strong background in web development, AI and robotics. I thrive on creating innovative projects that blend technology with real-world applications.

          </p>
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://github.com/mhammoud-os/"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://www.linkedin.com/in/malekhammoud/"
